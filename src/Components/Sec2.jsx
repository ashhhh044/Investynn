...
const Sec2 = () => {
  return (
    <>
        <section className="flex items-center justify-center gap-20 border-2 px-20 mx-auto rounded-lg bg-white border-t-2 border-t-[var(--line)] border-b-2 border-b-[var(--line)] border-l-0 border-r-0">
